// Inline SVG icons for DataSetHeader
// TODO: Replace with a shared icon library (e.g. @tabler/icons-react) when added to the project
...
export function IconLicense({ size = 16 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
